...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2023 at 01:51 PM
...
(6, 2, 3, 4, 100000, 400000),
(7, 3, 3, 4, 100000, 400000),
(8, 3, 3, 1, 100000, 100000),
(9, 3, 3, 5, 100000, 500000);
...
(3, 44, 'Mouse Logitech', 100000, 4),
(4, 44, 'Mouse Logitech', 0, 0),
(5, 44, 'Mouse Logitech', 0, 0),
(9, 44, 'Mouse Logitech', 123, 23);
...
INSERT INTO `supplier` (`id`, `namasupplier`) VALUES
(1, 'CV. Karya Sederhana'),
(2, 'CV. Percetakan Dian Samudra'),
(3, 'CV. Ekonomi Tani Maju'),
(4, 'CV. Permata Dunia'),
(5, 'CV. Sahabat Tani'),
(6, 'CV. Karunia Semesta');
...
(2, 44, '2021-10-31 18:25:35', 200000),
(3, 44, '2021-09-22 18:25:40', 500000),
(4, 44, '2021-11-01 04:55:26', 200000);
